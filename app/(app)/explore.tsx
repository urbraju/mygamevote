    ...
    return (
        <Container className="flex-1 bg-background">
            ...
            <ScrollView className="flex-1">
                <View className="max-w-7xl w-full self-center px-4 pt-6">
                    <View className="mb-8">
                        <Text className="text-white text-3xl font-black uppercase tracking-tight sm:text-4xl md:text-5xl">
                            Sports <Text className="text-primary">Hub</Text>
                        </Text>
                        <Text className="text-gray-400 mt-2 font-medium md:text-lg">
                            Personalized knowledge for your favorite sports.
                        </Text>
                        {!sportsHubEnabled && (
                            <View className="flex-row items-center bg-orange-500/10 border border-orange-500/20 rounded-xl px-3 py-2 mt-4 self-start">
                    ...
                    {isLoading ? (
                        ...
                        <View className="bg-surface rounded-3xl p-8 border border-white-10 items-center max-w-xl self-center w-full">
