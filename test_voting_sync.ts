...
import { getFirestore, doc, setDoc, getDoc, runTransaction, arrayUnion } from "firebase/firestore";
...
// Same transaction logic from votingService.ts
...
async function runTest() {
    try {
        ...
        const adminCred = await signInWithEmailAndPassword(auth, 'tladmin@test.com', 'admin123');
        ...
        const userCred = await signInWithEmailAndPassword(auth, 'gg@test.com', 'test1234');
